			...
			if (response.status == '200') {
				...
				str3 += `<img src="${site_url}/files/images/employee_images/mid_${
					...
					response.data.employee_data
						.profile_picture}" alt="..."><div style="text-decoration:underline;text-align:center;margin-top:5px;" data-toggle="modal" data-target="#edit_proPic_modal">Update Image</div>`;
				str3 += '</div>';
